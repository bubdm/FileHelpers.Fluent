...
namespace FileHelpers.Fluent.Core.Text
{
    /// <summary>
    ...
    public class EbcdicEncoding : Encoding
    {
        ...
        #region Encoding Properties

        public static Encoding EBCDIC_AT_DE => GetEncoding("EBCDIC-AT-DE");
        public static Encoding EBCDIC_AT_DE_A => GetEncoding("EBCDIC-AT-DE-A");
        public static Encoding EBCDIC_BE => GetEncoding("EBCDIC-BE");
        public static Encoding EBCDIC_BR => GetEncoding("EBCDIC-BR");
        public static Encoding EBCDIC_CA_FR => GetEncoding("EBCDIC-CA-FR");
        public static Encoding EBCDIC_CP_AR1 => GetEncoding("EBCDIC-CP-AR1");
        public static Encoding EBCDIC_CP_AR2 => GetEncoding("EBCDIC-CP-AR2");
        public static Encoding EBCDIC_CP_BE => GetEncoding("EBCDIC-CP-BE");
        public static Encoding EBCDIC_CP_CA => GetEncoding("EBCDIC-CP-CA");
        public static Encoding EBCDIC_CP_CH => GetEncoding("EBCDIC-CP-CH");
        public static Encoding EBCDIC_CP_DK => GetEncoding("EBCDIC-CP-DK");
        public static Encoding EBCDIC_CP_ES => GetEncoding("EBCDIC-CP-ES");
        public static Encoding EBCDIC_CP_FI => GetEncoding("EBCDIC-CP-FI");
        public static Encoding EBCDIC_CP_FR => GetEncoding("EBCDIC-CP-FR");
        public static Encoding EBCDIC_CP_GB => GetEncoding("EBCDIC-CP-GB");
        public static Encoding EBCDIC_CP_GR => GetEncoding("EBCDIC-CP-GR");
        public static Encoding EBCDIC_CP_HE => GetEncoding("EBCDIC-CP-HE");
        public static Encoding EBCDIC_CP_IS => GetEncoding("EBCDIC-CP-IS");
        public static Encoding EBCDIC_CP_IT => GetEncoding("EBCDIC-CP-IT");
        public static Encoding EBCDIC_CP_NL => GetEncoding("EBCDIC-CP-NL");
        public static Encoding EBCDIC_CP_NO => GetEncoding("EBCDIC-CP-NO");
        public static Encoding EBCDIC_CP_ROECE => GetEncoding("EBCDIC-CP-ROECE");
        public static Encoding EBCDIC_CP_SE => GetEncoding("EBCDIC-CP-SE");
        public static Encoding EBCDIC_CP_TR => GetEncoding("EBCDIC-CP-TR");
        public static Encoding EBCDIC_CP_US => GetEncoding("EBCDIC-CP-US");
        public static Encoding EBCDIC_CP_WT => GetEncoding("EBCDIC-CP-WT");
        public static Encoding EBCDIC_CP_YU => GetEncoding("EBCDIC-CP-YU");
        public static Encoding EBCDIC_CYRILLIC => GetEncoding("EBCDIC-CYRILLIC");
        public static Encoding EBCDIC_DK_NO => GetEncoding("EBCDIC-DK-NO");
        public static Encoding EBCDIC_DK_NO_A => GetEncoding("EBCDIC-DK-NO-A");
        public static Encoding EBCDIC_ES => GetEncoding("EBCDIC-ES");
        public static Encoding EBCDIC_ES_A => GetEncoding("EBCDIC-ES-A");
        public static Encoding EBCDIC_ES_S => GetEncoding("EBCDIC-ES-S");
        public static Encoding EBCDIC_FI_SE => GetEncoding("EBCDIC-FI-SE");
        public static Encoding EBCDIC_FI_SE_A => GetEncoding("EBCDIC-FI-SE-A");
        public static Encoding EBCDIC_FR => GetEncoding("EBCDIC-FR");
        public static Encoding EBCDIC_GREEK => GetEncoding("EBCDIC-GREEK");
        public static Encoding EBCDIC_INT => GetEncoding("EBCDIC-INT");
        public static Encoding EBCDIC_INT1 => GetEncoding("EBCDIC-INT1");
        public static Encoding EBCDIC_IS_FRISS => GetEncoding("EBCDIC-IS-FRISS");
        public static Encoding EBCDIC_IT => GetEncoding("EBCDIC-IT");
        public static Encoding EBCDIC_JP_E => GetEncoding("EBCDIC-JP-E");
        public static Encoding EBCDIC_JP_KANA => GetEncoding("EBCDIC-JP-KANA");
        public static Encoding EBCDIC_PT => GetEncoding("EBCDIC-PT");
        public static Encoding EBCDIC_UK => GetEncoding("EBCDIC-UK");
        public static Encoding EBCDIC_US => GetEncoding("EBCDIC-US");
        ...
        static EbcdicEncoding()
        {
            ...
            using (Stream data = Assembly.GetExecutingAssembly().
                GetManifestResourceStream("FileHelpers.Fluent.Core.Text.ebcdic.dat"))
            {
                if (data == null)
                    throw new Exception("EBCDIC encodings resource not found.");

                int encodings = data.ReadByte();
                if (encodings == -1)
                {
                    throw new Exception("EBCDIC encodings resource empty.");
                }
                ...
                for (int i = 0; i < encodings; i++)
                {
                    ...
                    if (nameLength == -1)
                    {
                        throw new Exception("EBCDIC encodings resource truncated.");
                    }
                    string name = "EBCDIC-" +
                ...
                if (data.ReadByte() != -1)
                    throw new Exception("EBCDIC encodings resource contains unused data.");
            }
        }
        #endregion
